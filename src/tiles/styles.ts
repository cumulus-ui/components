...
.tile-container {
  ...
  transition: border-color var(--motion-duration-transition-quick, 90ms) var(--motion-easing-transition-quick, linear), background-color var(--motion-duration-transition-quick, 90ms) var(--motion-easing-transition-quick, linear);
}
...
.tile-container.refresh.selected:not(.disabled):not(.readonly) {
  box-shadow: inset 0 0 0 var(--border-width-field, 1px) var(--color-border-item-focused, #006ce0);
}
...
.tile-container.selected {
  border-block: var(--border-width-field, 1px) solid var(--color-border-item-selected, #006ce0);
  border-inline: var(--border-width-field, 1px) solid var(--color-border-item-selected, #006ce0);
  background: var(--color-background-item-selected, #f0fbff);
}
.tile-container.disabled {
  border-block: var(--border-width-field, 1px) solid var(--color-border-tiles-disabled, #ebebf0);
  border-inline: var(--border-width-field, 1px) solid var(--color-border-tiles-disabled, #ebebf0);
  background: var(--color-background-tiles-disabled, #ebebf0);
}
...
.columns {
  display: flex;
  flex-wrap: wrap;
  margin-block: calc(var(--space-tile-gutter, 24px) / -4);
  margin-inline-start: calc(var(--space-tile-gutter, 24px) / -4);
  margin-inline-end: calc(var(--space-tile-gutter, 24px) / -4);
}
.columns.column-1 > .tile-container {
  margin-block: calc(var(--space-tile-gutter, 24px) / 4);
  margin-inline: calc(var(--space-tile-gutter, 24px) / 4);
  box-sizing: border-box;
  flex: 0 0 calc(100% - var(--space-tile-gutter, 24px)/2);
  max-inline-size: calc(100% - var(--space-tile-gutter, 24px)/2);
}
...
.columns.column-2 > .tile-container.breakpoint-xs {
  flex: 0 0 calc(50% - var(--space-tile-gutter, 24px)/2);
  max-inline-size: calc(50% - var(--space-tile-gutter, 24px)/2);
}
...
.columns.column-3 > .tile-container.breakpoint-xs {
  flex: 0 0 calc(33.3333333333% - var(--space-tile-gutter, 24px)/2);
  max-inline-size: calc(33.3333333333% - var(--space-tile-gutter, 24px)/2);
}
...
.columns.column-4 > .tile-container.breakpoint-xs {
  flex: 0 0 calc(25% - var(--space-tile-gutter, 24px)/2);
  max-inline-size: calc(25% - var(--space-tile-gutter, 24px)/2);
}
...
.control {
  flex-grow: 1;
  margin-block-end: var(--space-s, 12px);
}
.control.no-image {
  margin-block-end: 0;
}
