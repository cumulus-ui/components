...
.root > .list > .container {
  display: grid;
  grid-template-columns: var(--space-static-l, 20px) 1fr;
  grid-template-rows: minmax(var(--space-static-l, 20px), auto);
}
...
.root > .list > .container > .details {
  ...
  grid-row: 2;
  grid-column: 2;
  margin-block-end: var(--space-static-xs, 8px);
}
.root > .list > .container > .connector {
  ...
  border-block: 0;
  border-inline: 0;
  inline-size: var(--border-divider-list-width, 1px);
  block-size: auto;
  min-block-size: var(--space-static-xs, 8px);
  position: relative;
  inset-inline-end: var(--space-static-xxxs, 2px);
}
...
.horizontal > .list > .container > .header > .connector {
  ...
  min-block-size: 0;
  inset-inline-end: 0;
  block-size: var(--border-divider-list-width, 1px);
  inline-size: auto;
  min-inline-size: var(--space-static-xs, 8px);
  margin-inline-end: var(--space-static-xxs, 4px);
}
