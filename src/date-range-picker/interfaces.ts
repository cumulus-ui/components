...
export interface DateRangePickerProps extends ExpandToViewport, DateRangePickerBaseProps, Pick<CalendarProps, 'granularity'> {
  /**
...
export declare namespace DateRangePickerProps {
  ...
  type AbsoluteRangeControl = (selectedRange: PendingAbsoluteValue, setSelectedRange: (value: PendingAbsoluteValue) => void) => unknown;
  type RelativeRangeControl = (selectedRange: RelativeValue | null, setSelectedRange: (value: RelativeValue) => void) => unknown;
