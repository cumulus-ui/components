...
export interface WizardProps {
   ...
   * - `info` (unknown) - (Optional) Area for a page level info link that's displayed in the form header.
   ...
   * - `description` (unknown) - (Optional) Area below the form header for a page level description text to further explain the purpose, goal, or main actions of the step.
   * - `content` (unknown) - Main content area to display form sections, form fields, and controls.
   * - `errorText` (unknown) - (Optional) Error text that's displayed in a page level error alert.
