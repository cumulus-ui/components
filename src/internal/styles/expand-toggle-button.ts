...
.awsui-motion-disabled .expand-toggle-icon, .awsui-mode-entering .expand-toggle-icon {
  animation: none;
  transition: none;
}
...
.expand-toggle-icon-expanded:dir(rtl) {
  transform: rotate(0deg);
}
...
:host-context([data-awsui-focus-visible=true]) .expand-toggle:not(.disable-focus-highlight):focus {
  position: relative;
}
:host-context([data-awsui-focus-visible=true]) .expand-toggle:not(.disable-focus-highlight):focus {
...
:host-context([data-awsui-focus-visible=true]) .expand-toggle:not(.disable-focus-highlight):focus::before {
  content: " ";
  display: block;
  position: absolute;
