...
@media (max-width: 688px) {
  @media not print {
    :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer:not(.app-layout-visual-refresh-toolbar-drawer--ai-drawer), :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer:not(.app-layout-visual-refresh-toolbar-drawer--ai-drawer) {
...
@media not print {
  :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header-content, :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header-content {
    border-block-start: var(--border-divider-section-width, 1px) solid var(--color-border-layout, #c6c6cd);
  }
  @media (min-width: 689px) {
    :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header-content:has(+ .app-layout-visual-refresh-toolbar-drawer--drawer-back-to-console-slot), :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header-content:has(+ .app-layout-visual-refresh-toolbar-drawer--drawer-back-to-console-slot) {
      border-inline-end: var(--border-divider-section-width, 1px) solid var(--color-border-layout, #c6c6cd);
      border-start-end-radius: var(--space-xxs, 4px);
    }
  }
...
@media not print {
  :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-back-to-console-slot:before, :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-back-to-console-slot:before, :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-back-to-console-slot:after, :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container > .app-layout-visual-refresh-toolbar-drawer--drawer-content > .app-layout-visual-refresh-toolbar-drawer--drawer-content-header > .app-layout-visual-refresh-toolbar-drawer--drawer-back-to-console-slot:after {
    display: none;
  }
}
...
@media (min-width: 689px) {
  ...
  @media not print {
    :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer:not(.app-layout-visual-refresh-toolbar-drawer--drawer-expanded) > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container, :host-context(.awsui-dark-mode) .app-layout-visual-refresh-toolbar-drawer--drawer.app-layout-visual-refresh-toolbar-drawer--ai-drawer:not(.app-layout-visual-refresh-toolbar-drawer--drawer-expanded) > .app-layout-visual-refresh-toolbar-drawer--drawer-content-container {
      border-inline-end: var(--border-divider-section-width, 1px) solid var(--color-border-layout, #c6c6cd);
    }
  }
}
