...
.button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-root, .button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-nested {
  padding-block: 0px;
  padding-inline: var(--space-field-horizontal-0aq2ch, 12px);
...
:host-context([data-awsui-focus-visible=true]) .button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-root:focus, :host-context([data-awsui-focus-visible=true]) .button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-nested:focus {
  position: relative;
}
:host-context([data-awsui-focus-visible=true]) .button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-root:focus, :host-context([data-awsui-focus-visible=true]) .button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-nested:focus {
...
:host-context([data-awsui-focus-visible=true]) .button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-root:focus::before, :host-context([data-awsui-focus-visible=true]) .button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-nested:focus::before {
  content: " ";
  display: block;
  position: absolute;
...
.button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token-nested {
...
.button-trigger--button-trigger.button-trigger--disabled.button-trigger--button-trigger--in-filtering-token {
  background-color: var(--color-background-input-disabled-dihaja, #ebebf0);
...
.button-trigger--button-trigger.button-trigger--readonly:not(.button-trigger--button-trigger.button-trigger--disabled):not(.button-trigger--button-trigger.button-trigger--button-trigger--in-filtering-token) {
  background-color: var(--color-background-input-default-ifz5bb, #ffffff);
  border-block: var(--border-width-field-2xc78x, 1px) solid var(--color-border-input-disabled-zgnzvk, #ebebf0);
  border-inline: var(--border-width-field-2xc78x, 1px) solid var(--color-border-input-disabled-zgnzvk, #ebebf0);
}
...
:host-context([data-awsui-focus-visible=true]) .button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token):focus {
  outline: 2px dotted transparent;
...
.button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token):invalid {
  box-shadow: none;
}
.button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--invalid, .button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--invalid:focus {
...
.button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--invalid:focus, .button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--invalid:focus:focus {
...
.button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--warning, .button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--warning:focus {
  color: var(--color-text-status-warning-6meo06, #855900);
  border-color: var(--color-text-status-warning-6meo06, #855900);
  padding-inline-start: calc(var(--space-field-horizontal-0aq2ch, 12px) - (var(--border-invalid-width-3xd6e1, 8px) - var(--border-width-field-2xc78x, 1px)));
  border-inline-start-width: var(--border-invalid-width-3xd6e1, 8px);
}
.button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--warning:focus, .button-trigger--button-trigger:not(.button-trigger--button-trigger--in-filtering-token).button-trigger--warning:focus:focus {
  box-shadow: 0 0 0 var(--border-control-invalid-focus-ring-shadow-spread-9jjf96, 2px) var(--color-border-item-focused-uk47pl, #006ce0);
}
