...
.awsui-motion-disabled .button-trigger > .arrow, .awsui-mode-entering .button-trigger > .arrow {
  animation: none;
  transition: none;
}
...
.button-trigger.in-filtering-token-root, .button-trigger.in-filtering-token-nested {
  padding-block: 0px;
  padding-inline: var(--space-field-horizontal-0aq2ch, 12px);
...
:host-context([data-awsui-focus-visible=true]) .button-trigger.in-filtering-token-root:focus, :host-context([data-awsui-focus-visible=true]) .button-trigger.in-filtering-token-nested:focus {
  position: relative;
}
:host-context([data-awsui-focus-visible=true]) .button-trigger.in-filtering-token-root:focus, :host-context([data-awsui-focus-visible=true]) .button-trigger.in-filtering-token-nested:focus {
...
:host-context([data-awsui-focus-visible=true]) .button-trigger.in-filtering-token-root:focus::before, :host-context([data-awsui-focus-visible=true]) .button-trigger.in-filtering-token-nested:focus::before {
  content: " ";
  display: block;
  position: absolute;
...
.button-trigger.in-filtering-token-nested {
...
.button-trigger.disabled > .arrow {
  color: var(--color-text-button-inline-icon-disabled-82hho0, #b4b4bb);
}
.button-trigger.disabled.in-filtering-token {
  background-color: var(--color-background-input-disabled-dihaja, #ebebf0);
...
.button-trigger.disabled > .placeholder {
  color: var(--color-text-input-placeholder-disabled-wg87og, #b4b4bb);
}
.button-trigger.readonly:not(.button-trigger.disabled):not(.button-trigger.in-filtering-token) {
  background-color: var(--color-background-input-default-ifz5bb, #ffffff);
  border-block: var(--border-width-field-2xc78x, 1px) solid var(--color-border-input-disabled-zgnzvk, #ebebf0);
  border-inline: var(--border-width-field-2xc78x, 1px) solid var(--color-border-input-disabled-zgnzvk, #ebebf0);
}
...
:host-context([data-awsui-focus-visible=true]) .button-trigger:not(.in-filtering-token):focus {
  outline: 2px dotted transparent;
...
.button-trigger:not(.in-filtering-token):invalid {
  box-shadow: none;
}
.button-trigger:not(.in-filtering-token).invalid, .button-trigger:not(.in-filtering-token).invalid:focus {
...
.button-trigger:not(.in-filtering-token).invalid:focus, .button-trigger:not(.in-filtering-token).invalid:focus:focus {
...
.button-trigger:not(.in-filtering-token).warning, .button-trigger:not(.in-filtering-token).warning:focus {
  color: var(--color-text-status-warning-6meo06, #855900);
  border-color: var(--color-text-status-warning-6meo06, #855900);
  padding-inline-start: calc(var(--space-field-horizontal-0aq2ch, 12px) - (var(--border-invalid-width-3xd6e1, 8px) - var(--border-width-field-2xc78x, 1px)));
  border-inline-start-width: var(--border-invalid-width-3xd6e1, 8px);
}
.button-trigger:not(.in-filtering-token).warning:focus, .button-trigger:not(.in-filtering-token).warning:focus:focus {
  box-shadow: 0 0 0 var(--border-control-invalid-focus-ring-shadow-spread-9jjf96, 2px) var(--color-border-item-focused-uk47pl, #006ce0);
}
.button-trigger.custom-option {
  padding-block: 0;
  padding-inline-start: 0;
  overflow: clip;
}
.button-trigger.inline-tokens {
  padding-block: 0;
}
`;
