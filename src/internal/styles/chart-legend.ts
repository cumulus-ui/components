...
.awsui-motion-disabled .marker, .awsui-mode-entering .marker {
  animation: none;
  transition: none;
}
...
:host-context([data-awsui-focus-visible=true]) .marker:focus {
  position: relative;
}
:host-context([data-awsui-focus-visible=true]) .marker:focus {
...
:host-context([data-awsui-focus-visible=true]) .marker:focus::before {
  content: " ";
  display: block;
  position: absolute;
