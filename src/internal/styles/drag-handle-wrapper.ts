...
@keyframes awsui_drag-handle-entry_155yk_1rpq3_1 {
  from {
    transform: translate(var(--awsui-drag-handle-animation-inline-offset), var(--awsui-drag-handle-animation-block-offset));
  }
  to {
...
.drag-handle-wrapper--direction-button-wrapper {
  --awsui-drag-handle-animation-inline-offset: 0;
  --awsui-drag-handle-animation-block-offset: 0;
}
...
.drag-handle-wrapper--direction-button-wrapper-motion-entering {
  animation: awsui_drag-handle-entry_155yk_1rpq3_1 var(--motion-duration-complex, 250ms) var(--motion-easing-responsive, cubic-bezier(0, 0, 0, 1)), awsui_awsui-motion-fade-in_155yk_1rpq3_1 var(--motion-duration-complex, 250ms) var(--motion-easing-responsive, cubic-bezier(0, 0, 0, 1));
}
...
.drag-handle-wrapper--direction-button-wrapper-motion-exiting {
  animation: awsui_drag-handle-exit_155yk_1rpq3_1 var(--motion-duration-complex, 250ms) var(--motion-easing-responsive, cubic-bezier(0, 0, 0, 1)) forwards, awsui_awsui-motion-fade-out-0_155yk_1rpq3_1 var(--motion-duration-complex, 250ms) var(--motion-easing-responsive, cubic-bezier(0, 0, 0, 1)) forwards;
}
@media (prefers-reduced-motion: reduce) {
  .drag-handle-wrapper--direction-button-wrapper-motion-exiting {
    animation: none;
...
.drag-handle-wrapper--direction-button-wrapper-block-start {
  --awsui-drag-handle-animation-block-offset: 20px;
}
...
.drag-handle-wrapper--direction-button-wrapper-inline-start:dir(ltr) {
  --awsui-drag-handle-animation-inline-offset: 20px;
}
...
.drag-handle-wrapper--direction-button-wrapper {
  position: absolute;
  block-size: var(--space-static-xl, 24px);
  inline-size: var(--space-static-xl, 24px);
  padding-block: var(--space-static-xxs, 4px);
  padding-inline: var(--space-static-xxs, 4px);
}
...
.drag-handle-wrapper--direction-button-wrapper-block-start {
  inset-block-start: calc(-1 * (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)));
  inset-inline-start: calc(50% - (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)) / 2);
}

.drag-handle-wrapper--direction-button-wrapper-block-end {
  inset-block-end: calc(-1 * (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)));
  inset-inline-start: calc(50% - (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)) / 2);
}

.drag-handle-wrapper--direction-button-wrapper-inline-start {
  inset-inline-start: calc(-1 * (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)));
  inset-block-start: calc(50% - (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)) / 2);
}

.drag-handle-wrapper--direction-button-wrapper-inline-end {
  inset-inline-end: calc(-1 * (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)));
  inset-block-start: calc(50% - (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)) / 2);
}
...
.drag-handle-wrapper--direction-button-wrapper-forced-top-1 {
  inset-block-start: calc(-2 * (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)));
}

.drag-handle-wrapper--direction-button-wrapper-forced-top-2 {
  inset-block-start: calc(-3 * (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)));
}

.drag-handle-wrapper--direction-button-wrapper-forced-top-3 {
  inset-block-start: calc(-4 * (var(--space-static-xl, 24px) + 2 * var(--space-static-xxs, 4px)));
}
...
.drag-handle-wrapper--direction-button {
  ...
  background-color: var(--color-background-direction-button-default, #424650);
  color: var(--color-text-direction-button-default, #ffffff);
...
.drag-handle-wrapper--direction-button:not(.drag-handle-wrapper--direction-button-disabled):hover {
  background-color: var(--color-background-direction-button-hover, #333843);
}
.drag-handle-wrapper--direction-button:not(.drag-handle-wrapper--direction-button-disabled):active {
  background-color: var(--color-background-direction-button-active, #232b37);
}

.drag-handle-wrapper--direction-button-disabled {
  cursor: default;
  background-color: var(--color-background-direction-button-disabled, #ebebf0);
  color: var(--color-text-direction-button-disabled, #b4b4bb);
}
`;
