...
.selectable-item--selectable-item.selectable-item--parent.selectable-item--selectable-item--interactiveGroups:not(.selectable-item--highlighted):not(.selectable-item--selected) {
  box-shadow: inset 0 var(--border-divider-list-width-tdfx1x, 1px) 0 0 var(--color-border-dropdown-item-default-kape37, #c6c6cd), inset 0 calc(-1 * var(--border-divider-list-width-tdfx1x, 1px)) 0 0 var(--color-border-dropdown-item-default-kape37, #c6c6cd);
}
.selectable-item--selectable-item > .selectable-item--selectable-item--selectable-item-content {
...
.selectable-item--selectable-item.selectable-item--pad-bottom > .selectable-item--selectable-item--selectable-item-content {
...
.selectable-item--selectable-item.selectable-item--child > .selectable-item--selectable-item--selectable-item-content {
  padding-inline-start: var(--space-xxl-32srm4, 32px);
}
.selectable-item--selectable-item.selectable-item--disabled > .selectable-item--selectable-item--selectable-item-content {
...
.selectable-item--selectable-item.selectable-item--highlighted.selectable-item--disabled > .selectable-item--selectable-item--selectable-item-content {
...
.selectable-item--selectable-item.selectable-item--selected.selectable-item--selectable-item--next-item-selected {
...
.selectable-item--selectable-item.selectable-item--selected + .selectable-item--selectable-item.selectable-item--selected, .selectable-item--selectable-item.selectable-item--selected.selectable-item--selectable-item--previous-item-selected {
  border-start-start-radius: 0;
  border-start-end-radius: 0;
}
.selectable-item--selectable-item.selectable-item--parent:not(.selectable-item--disabled) > .selectable-item--selectable-item--selectable-item-content {
  color: var(--color-text-dropdown-group-label-2tmyik, #424650);
}
.selectable-item--selectable-item.selectable-item--parent:not(.selectable-item--selectable-item--interactiveGroups) {
...
.selectable-item--selectable-item.selectable-item--parent:not(.selectable-item--selectable-item--interactiveGroups):not(:has(> .selectable-item--selectable-item--selectable-item-content)) {
  padding-block: var(--border-item-width-miijiw, 2px);
  padding-inline: var(--border-item-width-miijiw, 2px);
}
.selectable-item--selectable-item.selectable-item--parent:not(.selectable-item--selectable-item--interactiveGroups) > .selectable-item--selectable-item--selectable-item-content {
  padding-block: var(--space-xs-ymlm0b, 8px);
  padding-inline: var(--space-xs-ymlm0b, 8px);
  font-weight: bold;
}
.selectable-item--selectable-item.selectable-item--parent.selectable-item--selectable-item--interactiveGroups > .selectable-item--selectable-item--selectable-item-content {
  padding-block: var(--space-xs-ymlm0b, 8px);
  padding-inline: var(--space-field-horizontal-0aq2ch, 12px);
  font-weight: bold;
}
.selectable-item--selectable-item.selectable-item--parent.selectable-item--selectable-item--interactiveGroups.selectable-item--highlighted > .selectable-item--selectable-item--selectable-item-content {
  color: var(--color-text-dropdown-item-highlighted-yr1px8, #0f141a);
}
.selectable-item--selectable-item:not(.selectable-item--disabled):not(.selectable-item--parent), .selectable-item--selectable-item.selectable-item--selectable-item--interactiveGroups:not(.selectable-item--disabled) {
  cursor: pointer;
}
...
.selectable-item--selectable-item.selectable-item--sticky > .selectable-item--selectable-item--selectable-item-content {
  padding-inline: var(--space-field-horizontal-0aq2ch, 12px);
}
...
.selectable-item--selectable-item.selectable-item--virtual.selectable-item--parent:not(.selectable-item--selectable-item--interactiveGroups) {
  box-shadow: inset 0 var(--border-divider-list-width-tdfx1x, 1px) 0 0 var(--color-border-dropdown-group-ylcnh8, #c6c6cd), inset 0 calc(-1 * var(--border-divider-list-width-tdfx1x, 1px)) 0 0 var(--color-border-dropdown-item-default-kape37, #c6c6cd);
}
...
.selectable-item--selectable-item--screenreader-content {
