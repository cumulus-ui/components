...
.table-resizer--resizer-wrapper {
  inset-block: 0;
  position: absolute;
  inset-inline-end: calc(-1 * var(--space-xl, 24px) / 2);
...
.table-resizer--divider-interactive {
  ...
  inset-block-end: 0;
  inset-block-start: 0;
  min-block-size: var(--line-height-heading-xs, 18px);
  max-block-size: calc(100% - calc(2 * var(--space-xs, 8px) + var(--space-xxxs, 2px)));
  margin-block: auto;
  margin-inline: auto;
  border-inline-start: var(--border-item-width, 2px) solid var(--color-border-divider-interactive-default, #8c8c94);
  box-sizing: border-box;
}

th:not(:last-child) > .table-resizer--divider-disabled {
  border-inline-start-color: var(--color-border-divider-default, #c6c6cd);
}

.table-resizer--divider-interactive {
  inset-inline-end: calc(var(--space-xl, 24px) / 2);
}
...
.table-resizer--divider-active {
  border-inline-start: 2px solid var(--color-border-divider-active, #0f141a);
}
...
:host-context([data-awsui-focus-visible=true]) .table-resizer--resizer.table-resizer--has-focus {
  ...
  outline-offset: calc(calc(var(--space-table-header-focus-outline-gutter, 0px) - 2px) - 1px);
}
:host-context([data-awsui-focus-visible=true]) .table-resizer--resizer.table-resizer--has-focus::before {
  content: " ";
  display: block;
  position: absolute;
  inset-inline-start: calc(-1 * calc(var(--space-table-header-focus-outline-gutter, 0px) - 2px));
  inset-block-start: calc(-1 * calc(var(--space-table-header-focus-outline-gutter, 0px) - 2px));
  inline-size: calc(100% + calc(var(--space-table-header-focus-outline-gutter, 0px) - 2px) + calc(var(--space-table-header-focus-outline-gutter, 0px) - 2px));
  block-size: calc(100% + calc(var(--space-table-header-focus-outline-gutter, 0px) - 2px) + calc(var(--space-table-header-focus-outline-gutter, 0px) - 2px));
...
.table-resizer--tracker {
  display: none;
  position: absolute;
  border-inline-start: var(--border-divider-list-width, 1px) dashed var(--color-border-divider-active, #0f141a);
  inline-size: 0;
  inset-block: 0;
}
