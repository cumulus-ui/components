...
.select-parts--item > .select-parts--checkbox {
  ...
  margin-inline-end: var(--space-field-horizontal, 12px);
}
...
.select-parts--show-label-tag > .select-parts--selected-icon {
  padding-inline-start: var(--space-scaled-s, 12px);
}
...
.select-parts--inline-label-wrapper {
  margin-block-start: calc(var(--space-scaled-xs, 8px) * -1);
}

.select-parts--inline-label {
  background: linear-gradient(to bottom, var(--color-background-layout-main, #ffffff), var(--color-background-input-default, #ffffff));
  ...
  position: relative;
  inset-inline-start: calc(var(--border-width-field, 1px) + var(--space-field-horizontal, 12px) - var(--space-scaled-xxs, 4px));
  margin-block-start: var(--space-scaled-xs, 8px);
  padding-block-end: 2px;
  padding-inline: var(--space-scaled-xxs, 4px);
  max-inline-size: calc(100% - 2 * var(--space-field-horizontal, 12px));
  z-index: 1;
}
.select-parts--inline-label-disabled {
  background: linear-gradient(to bottom, var(--color-background-layout-main, #ffffff), var(--color-background-input-disabled, #ebebf0));
}
