...
import { BaseChangeDetail, BaseInputProps, InputAutoCorrect } from '../input/interfaces.js';
export interface TimeInputProps extends BaseInputProps, InputAutoCorrect {
  /**
