...
export type DefineIconsInput = Partial<Record<BuiltInIconName | (string & {}), unknown>>;
...
export declare namespace IconProviderProps {
  type Icons = { [name in IconProps.Name]?: unknown | null };
}
