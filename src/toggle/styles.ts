...
.toggle-control {
  ...
  margin-block-start: calc((var(--line-height-body-m, 20px) - 16px) / 2);
  min-block-size: 16px;
  min-inline-size: 24px;
  block-size: 16px;
  inline-size: 24px;
  background: var(--color-background-toggle-default, #424650);
...
.toggle-control-checked {
  background: var(--color-background-control-checked, #006ce0);
}
...
.toggle-control-disabled.toggle-control-checked {
  background: var(--color-background-toggle-checked-disabled, #b8e7ff);
}
...
.toggle-handle {
  ...
  background: var(--color-foreground-control-default, #ffffff);
  box-shadow: 1px 1px rgba(0, 0, 0, 0.25);
  inline-size: 12px;
  block-size: 12px;
  inset-block-start: 2px;
  inset-inline-start: 2px;
  transition: transform var(--motion-duration-fast, 90ms) var(--motion-easing-ease-out-quart, cubic-bezier(0.165, 0.84, 0.44, 1)), background-color var(--motion-duration-fast, 90ms) var(--motion-easing-ease-out-quart, cubic-bezier(0.165, 0.84, 0.44, 1));
}
...
.toggle-handle-disabled {
  background: var(--color-foreground-control-disabled, #ffffff);
  box-shadow: none;
}
